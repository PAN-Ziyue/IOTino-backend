export default {
  ...
  'userandregister.login.no-account-yet': '还没有账户？',
  ...
  'userandregister.register-result.msg': '注册成功',
  ...
  'userandregister.account.length': '请输入至少 6 个字符。',
  'userandregister.strength.msg': '请至少输入 6 个字符。请不要使用容易被猜到的密码。',
  'userandregister.account.required': '请输入用户名！',
  'userandregister.account.placeholder': '用户名',
